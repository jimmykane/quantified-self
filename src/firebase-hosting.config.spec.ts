...
describe('Firebase Hosting configuration', () => {
  ...
  it('marks recently updated public discovery surfaces in sitemap', () => {
    expect(sitemapLastmodForUrl(`${siteOrigin}/`)).toBe('2026-09-08');
    ...
    expect(sitemapLastmodForUrl(`${siteOrigin}/features/mcp-server`)).toBe('2026-09-11');
    ...
    expect(sitemapLastmodForUrl(`${siteOrigin}/help`)).toBe('2026-09-10');
