...
describe('Firebase Hosting configuration', () => {
  ...
  it('marks recently updated public discovery surfaces in sitemap', () => {
    ...
    expect(sitemapLastmodForUrl(`${siteOrigin}/features/mcp-server`)).toBe('2026-09-21');
    ...
    expect(sitemapLastmodForUrl(`${siteOrigin}/help`)).toBe('2026-09-21');
    expect(sitemapLastmodForUrl(`${siteOrigin}/policies`)).toBe('2026-09-21');
