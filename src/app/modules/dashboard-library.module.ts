import { DashboardHealthChartComponent } from '../components/charts/health/dashboard-health-chart.component';
...
@NgModule({
    ...
    exports: [SummariesComponent, DashboardChartLibraryComponent],
    declarations: [
        SummariesComponent,
