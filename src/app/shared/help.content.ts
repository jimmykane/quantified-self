...
- On a touch screen, pinch with two fingers on an Event details chart to zoom its horizontal axis. The same time or distance range appears across the other event charts and the zoom bar; vertical page scrolling remains available.
