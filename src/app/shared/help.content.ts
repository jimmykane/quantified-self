...
- Use **All sports** on desktop to switch between **All training** and Running, Cycling, Swimming, Rowing, Walking & Hiking, Nordic Skiing, Strength, or Paddling. On mobile, **All** and your compact swipeable sport buttons switch the common views in one tap; the compact **All sports** arrow button opens every sport with the current view marked, and **Manage sport shortcuts** moves shortcut editing into that same picker. Your last destination is saved to your account, not the URL. **Shortcuts** pins up to four sports for faster desktop and mobile switching; every sport remains in the complete picker. Until you save shortcuts, Training ranks them automatically from training duration and workouts in the latest 28 days, with saved sport benchmarks as fallback evidence. A fixed shortcut choice remains until you change it, and **Use automatic selection** restores automatic behavior. Shortcuts change navigation only and never hide a sport from totals or the complete picker.
