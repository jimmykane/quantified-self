...
- Selecting a day keeps the calendar visible and updates the day panel. The selected view and date are kept in the URL, so refreshing, sharing the authenticated route, or using browser Back restores the same day.
...
- **Activity Calendar** is a full-width dashboard tile. It shows the current month and a selected day's activities, health, notes, and plans, with a link to the full [Calendar](/calendar). Existing Calendar tiles expand once while other tiles keep their settings; add it from **Activity Overview** when you want it. The [Activity Calendar guide](/help#activity-calendar) explains its views, circles, summaries, and data scope.
