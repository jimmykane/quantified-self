...
- Search within the section, use **Load**, **Readiness**, or **Execution** to filter KPIs, and scroll the compact chart list. If a filter excludes the previewed chart, select a matching row before adding.
