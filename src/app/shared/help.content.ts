...
- In **Zoom** chart mode, pinch with two fingers on a touch screen to zoom an Event details chart's horizontal axis. The same time or distance range appears across the other event charts and the zoom bar; vertical page scrolling remains available. Pinching a chart in **Select** mode does not change its range.
