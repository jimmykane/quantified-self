...
- Use **Sports shown** to personalize detail cards for Running, Cycling, Swimming, Rowing, Walking & Hiking, Nordic Skiing, Strength, and Paddling. Until you save a choice, Training selects families automatically from activities in the latest 28 days and saved sport benchmarks. While that evidence is loading, or when none qualifies, sport cards stay hidden while the global Training sections remain available. A saved choice remains fixed until you change it, and **Use automatic selection** restores automatic behavior.
