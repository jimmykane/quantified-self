...
- Plans and standalone workouts work without a service connection. Wahoo workout delivery is available to connected Pro members; Garmin, Suunto, and COROS delivery remain limited rollouts. New COROS plan sync setup in the app is shown as **Coming soon**; existing enabled COROS plan sync still follows its saved settings and plan status, while standalone **Send to COROS** remains available to eligible pilot accounts. Connecting a service does not send anything automatically.
...
`,
  ...
  },
  {
    ...
    summary: 'Create plans and standalone workouts, use approval-gated MCP planning, and manage Wahoo or limited-rollout provider delivery.',
