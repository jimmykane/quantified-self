...
- Individual activity detail access covers bounded activity summaries with exact start/end latitude/longitude coordinates when available, laps, swim lengths, MTB jumps, and signed-in app links containing stable account/event paths. Jump records can also include exact latitude/longitude coordinates. Exact activity and jump coordinates can reveal your home, workplace, frequent trailhead, or other sensitive locations. Raw streams, activity names and notes, original files, device/provider provenance, and arbitrary stored stats are excluded.
