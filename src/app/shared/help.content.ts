...
- **Services** is where you connect Garmin, Suunto, COROS, and Wahoo. Connection screens read a limited account summary; provider access and refresh credentials stay server-only and are never sent to the browser.
