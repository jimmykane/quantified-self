...
During the limited Garmin Health rollout, Garmin can also send source-attributed Daily, Stress Details, HRV, User Metrics, Body Composition, Pulse Ox, All-day Respiration, Blood Pressure, Skin Temperature, and Health Snapshot summaries. Missing measurements remain unavailable, Garmin Body Battery remains provider-specific, and these Health records do not replace Sleep sessions or workout metrics. The normal Sleep history picker does not request those families; historical Health replay is handled through Garmin Summary Resender after live delivery is verified.
...
See [Policies -> Garmin Data](/policies#garmin-data) for the provider-specific privacy summary for Garmin imports, Sleep and staged Health data, and Garmin to Suunto sync.
