...
- Each Health tile has its own **Source and reading** selector, **1d**, **14d**, **30d**, **90d**, or **1y** range, and older/newer controls. Source choices include only readings that can be shown in the selected period. Provider accounts and different kinds of readings stay separate. A previously selected reading with no data stays selected and explains what is missing. Changing one tile does not change another tile or your Health hub preferences. Detailed readings without long-range summaries offer **Show 30 days**.
