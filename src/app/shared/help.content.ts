...
- An MCP client can read data only after you sign in and approve its requested permissions. **Activity and Training metrics**, **Body measurements**, **Individual activity details**, **Sleep summaries**, and **Saved routes and waypoints** are separate, optional read-only permissions. Existing metric connections do not gain body-measurement access automatically.
