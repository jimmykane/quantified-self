...
- After adding a chart, **Undo** removes that addition until another dashboard change makes it unsafe to undo. If the dashboard changed elsewhere, reopen the editor with the current layout before saving again.
