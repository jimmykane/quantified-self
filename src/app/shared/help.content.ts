...
- An MCP client can read data only after you sign in and approve its requested permissions. Every requested permission starts checked, including permissions added later; uncheck anything you do not want to grant before approving. **Activity and Training metrics**, **Health metrics**, **Body measurements**, **Individual activity details**, **Activity descriptions**, **Activity locations**, **Sleep summaries**, **Saved-route summaries**, and **Saved-route locations and geometry** are separate, optional read-only permissions. Activity locations require activity details; saved-route locations require saved-route summaries. Removing activity details also removes its descriptions and location permissions; removing saved-route summaries removes its location permission.
