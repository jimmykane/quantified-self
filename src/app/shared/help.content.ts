...
- KPI previews load your recorded training data when you open the picker, including KPIs you have not added yet. Their small trends use the same data and colors as the dashboard tiles. A KPI without enough history can show its current value without a trend.
