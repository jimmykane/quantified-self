...
- Completed Wahoo activities can link to a QS-delivered workout when Wahoo returns the exact Workout, Plan and app-supplied workout token under the same connected account. QS then shows **Completed · activity linked** and keeps the sent workout. This proves which delivered workout produced the recorded activity; it does not prove that every prescribed interval or target was completed. Missing, conflicting or ambiguous identifiers stay unlinked. The service identifiers and account evidence remain private, and deleting the activity removes the local link and evidence.
