...
- **Add your own Weight or VO₂ max.** Select either metric and use **Add measurement**. Weight is stored as a canonical point measurement. VO₂ max also records whether it is General, Running, or Cycling and whether it came from a lab test, field test, or another estimate. Your unit preference is applied for display. You can edit or delete your own manual rows from **Source observations**; stale edits are rejected instead of overwriting a newer change.
