...
If Wahoo rejects repeated token refreshes, its connection card changes to **Reconnect required**. Select **Reconnect** there to authorize Wahoo again. Quantified Self keeps unaccepted automatic activity and saved-route deliveries parked while reconnecting, then resumes them safely after the new connection succeeds; it does not turn your saved route settings off.
