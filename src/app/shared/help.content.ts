...
- Manual planning is available without a provider connection. Garmin, COROS and Suunto workout delivery are restricted to the private rollout; connecting a service does not send anything automatically. Wahoo delivery is not enabled yet.
...
- Garmin, COROS and Suunto workout delivery are restricted to the private rollout, not a public launch. Wahoo delivery is not enabled yet. Send controls stay hidden for unavailable providers and accounts; existing delivery details and removal controls remain accessible if a provider is paused.
