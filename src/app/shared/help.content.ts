...
- **Training** is a fixed analytical workspace rather than a set of draggable dashboard tiles. It brings together a **28-day status** compared with your usual training, **Readiness today**, **What drove this**, **Load trajectory**, **Training mix**, **Durability**, and **Settings vs recent evidence**.
...
- **Power-system strain** appears in an individual workout’s Performance area when recorded power and its power curve support the three-dimensional model. It shows that workout’s sustained-power, finite-capacity, and maximum-power strain components with input and fit quality. It is not TSS, FTP, fitness, fatigue, or Readiness, and workouts from different activity types are never combined. Earlier protocol and historic power-curve records without the stat ask for reprocessing; missing or ineligible evidence remains unavailable rather than zero.
...
- **Power-system strain** is per workout. It needs recorded power plus a power curve covering short, medium, and long efforts; it can be available for any sport with qualifying power data. The three values describe that workout’s modeled sustained-power, finite-capacity, and maximum-power strain, not an athlete-wide score or a replacement for TSS.
