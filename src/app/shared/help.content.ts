...
- Power systems shows today plus sparse workout-date points from the latest 12 weeks. A value appears only when Sports-lib marks that component ready; partial, insufficient, poor-fit, unstable, and invalid evidence remains explicit instead of becoming zero. The cards expose source coverage and fit/stability diagnostics, but they are capacity evidence—not TSS, FTP, fitness, fatigue, Readiness, or a workout prescription.
