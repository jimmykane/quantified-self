...
- Health opens on **Resting heart rate · 30d**. Choose any metric in the complete category list, then use **14d**, **30d**, **90d**, or **1y** and the older/newer controls. The URL retains the metric, range, and window end date so the view can be revisited.
