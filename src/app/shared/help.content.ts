...
- Use **All sports** on desktop or **Training view** on mobile to switch between **All training** and Running, Cycling, Swimming, Rowing, Walking & Hiking, Nordic Skiing, Strength, or Paddling. Your last destination is saved to your account, not the URL. **Shortcuts** pins up to four sports for faster desktop switching; every sport remains in the selector. Until you save shortcuts, Training ranks them automatically from training duration and workouts in the latest 28 days, with saved sport benchmarks as fallback evidence. A fixed shortcut choice remains until you change it, and **Use automatic selection** restores automatic behavior. Shortcuts change navigation only and never hide a sport from totals or the selector.
