...
- Standard Mountain Biking uses the normal Cycling endurance analysis. Enduro and Downhill stay within Cycling but use gravity-aware volume summaries: Training shows reliable recorded values such as time, distance, ascent/descent, descent time, jumps, grit, or flow when present. It does not invent downhill runs or uplift/lift segments, does not interpret zones or TSS as gravity-specific load, and does not show steady-aerobic durability for those contexts.
