...
- **Delivery history** appears in Plans once delivery records exist. Compact rows show each workout's current status and latest confirmation/attempt time, not a card for every edit. Open a row's **Delivery details** arrow for warnings and recovery, even after you delete a workout or its plan; this does not restore the deleted workout or start new sync. Loaded details stay up to date automatically. Authored edits remain in the separate, compact, scrollable **Revision history** with restore actions.
