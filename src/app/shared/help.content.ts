...
- Below the full calendar, **Sport families** compares the selected period by **Duration**, **Distance**, **Ascent**, or **Descent**. Each family uses the same color as its calendar circles, and its bar is scaled against the largest recorded family for that metric. Positive recorded duration, distance, ascent, and descent totals appear with icons beneath each bar. Lift-served downhill activities such as alpine skiing, snowboarding, and downhill cycling do not add ascent but do contribute descent, and your ascent/descent summary exclusions in **Settings** also apply. **N/A** means the selected metric does not apply to that family, while **--** means it applies but was not recorded.
