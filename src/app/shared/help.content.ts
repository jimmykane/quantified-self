...
- On phones, open **View options** at the bottom of the metric explorer to choose the date range and sources together, then tap **Apply**. **Cancel** leaves the view unchanged. The compact bar shows the active range and source selection; the inspected date and older/newer arrows stay above the chart. These options affect only the selected metric, not Highlights. A lone source is shown as a label instead of a redundant selector. Desktop keeps its inline range and source controls.
...
- The compact source footer shows each provider's recency and links to **Connectivity** for connection and import management.
