...
- New dashboards start with a full-width **Activity Calendar** tile showing the current month. Select a date to preview its activities, notes, and plans beside the calendar or below it when the tile is narrow. The preview shows the first two entries in each group and counts the rest. Earlier dates also show their available health readings; today's health stays in the Today summary above. **Full day** opens a dedicated page with every entry and previous/next day controls.
