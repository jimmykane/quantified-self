...
- When a retained FIT source records dive gases, tank summaries, or tank pressure updates, the **Diving** summary tab also shows a source-native **Gas & Tanks** section. It keeps every selected dive separate and displays the parser's recorded percentages, bar, litres, timestamps, and source enum values. The app does not invent a gas mixture name or nitrogen value, associate a gas with a tank, calculate consumption, or create missing records.
