    ...
    topics: [
        ...
        },
        {
            ...
            content: [
                ...
                '<strong>Shared with Wahoo:</strong> You can explicitly send a selected FIT activity file or GPX/FIT course/route file directly to Wahoo, or turn on/send a date range for Garmin, COROS, or Suunto activities already stored in Quantified Self. Quantified Self converts selected GPX routes to FIT in memory before sending them to Wahoo. Direct Wahoo activity delivery does not create or retain a Quantified Self activity; direct course/route delivery does not create or retain a Quantified Self route.',
