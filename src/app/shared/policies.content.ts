    ...
    topics: [
        ...
        },
        {
            ...
            content: [
                ...
                '<strong>Sleep permission:</strong> Sleep access can return normalized session summaries, day/week/month aggregates, and bounded discovery of which safe aggregate vital types have recorded values in a requested period. This lets a client discover available HRV, heart-rate, blood-oxygen, and respiration values before it requests nightly or grouped results. When Activity and Training metrics are also approved, the client can request a compact morning briefing for an explicit IANA timezone: the latest completed non-nap sleep, a short same-provider duration comparison, current-versus-usual equivalent 28-day Training totals and Running/Cycling/Swimming mix, and a current UTC-day Training readiness status. The briefing excludes provider identity, provider user and session identifiers, provider-specific payloads, raw sleep-stage intervals, score components, raw HRV, SpO2, respiration samples, locations, activities, body measurements, workout plans, and medical advice.',
