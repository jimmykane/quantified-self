...
export const CONNECTED_SERVICES_POLICY_SECTION: ConnectedServicesPolicySection = {
    ...
    content: [
        ...
        '<strong>Manual Health measurements:</strong> You can add, edit, and delete Weight and VO₂ max measurements in the authenticated Health workspace. They are stored in your owner-scoped Health history with Quantified Self as the source, the observed time and timezone offset, and—for VO₂ max—the context and method you select. Manual values remain separate from provider and workout series. Account deletion removes them with the rest of your Health history.',
