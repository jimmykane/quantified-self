...
export const CONNECTED_SERVICES_POLICY_SECTION: ConnectedServicesPolicySection = {
    ...
    content: [
        '<strong>Private Timeline notes:</strong> Notes you create about sickness, injury, vacation, travel, stress, or other context are stored beneath your account with calendar dates, the captured time zone, and revision timestamps. They appear only in your authenticated Health, Sleep, and Training views and do not change measurements or scores. Text is not sent to providers, analytics, public shares, MCP clients, or the Assistant. Deleting a note removes its content and retains only a content-free deletion receipt to prevent delayed retries from recreating it. Disconnecting a service retains notes; account deletion recursively removes notes and receipts.',
