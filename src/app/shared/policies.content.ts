    ...
    topics: [
        ...
        },
        {
            ...
            content: [
                ...
                '<strong>Optional Assistant note context:</strong> Timeline notes access is off by default. Enabling or disabling it starts a fresh server-owned chat and preserves the independently selected location permission. Changing location access likewise preserves the notes choice; New chat resets both. When relevant, Gemini may receive full private titles and details, including notes hidden from charts. Notes are user-reported context, not verified diagnoses, causal proof, model instructions or authorization to change plans. Raw tool responses are not stored; answers may quote relevant details, and compact evidence identifies note context and dates under the existing conversation retention policy.',
