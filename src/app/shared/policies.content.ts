    ...
    topics: [
        ...
        },
        {
            ...
            content: [
                ...
                '<strong>Stored and used in Quantified Self:</strong> Imported Wahoo FIT activities, source identifiers, summary revision metadata, and original activity files are used for event analysis, dashboard metrics, exports, deduplication, and reprocessing. Wahoo does not currently supply the daily wellness measurements shown in the Health workspace, so Wahoo activity values are not presented there as Health records. OAuth credentials are stored server-side and are not readable by the browser.',
