    ...
    topics: [
        ...
        },
        {
            ...
            content: [
                ...
                '<strong>Shared from Suunto to connected destinations:</strong> You can opt in to automatic activity delivery or select a past stored date range for Wahoo or COROS. You can separately opt in to new and updated saved Suunto route delivery, or send existing saved routes, to Garmin Connect or Wahoo; approved COROS route-pilot accounts can also select COROS while production route-push permission is verified. Quantified Self sends only the retained activity file or saved-route representation required by the selected destination.',
        ...
        },
        {
            ...
            title: 'COROS Data',
            icon: 'sync',
            summary: 'COROS activity, sleep-summary, activity sync, FIT upload, and GPX/FIT or saved-route delivery workflows.',
            content: [
                ...
                '<strong>Shared back to COROS:</strong> You can send a selected FIT activity, automatically send new Garmin/Suunto/Wahoo FIT activities, or send a selected past date range already stored in Quantified Self. Approved COROS route-pilot accounts can also send a selected GPX/FIT route, a saved route from Routes, or opt in to new/updated or existing saved Suunto route delivery while production route-push permission is verified. Selected route files are parsed and converted to GPX in memory and do not create a Quantified Self route; saved routes retain provider delivery metadata for deduplication and status.',
