    ...
    topics: [
        ...
        },
        {
            ...
            content: [
                ...
                '<strong>Outbound boundaries:</strong> Wahoo-to-Suunto is the only Wahoo-origin provider-to-provider activity route. Plans, routes, sleep, and other non-activity data are not sent between Wahoo and another provider. Existing Wahoo connections may need to be reconnected to grant workout write access for delivery to Wahoo.',
            ],
        },
        {
