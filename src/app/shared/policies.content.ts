    ...
    topics: [
        ...
        },
        {
            ...
            content: [
                ...
                '<strong>Activity-detail permission:</strong> Individual activity access can return bounded activity summaries, laps, swim lengths, MTB jump measurements, and direct links containing stable account/event paths that still require your normal Quantified Self sign-in. Jump records can include their exact latitude and longitude. Raw streams, activity names and notes, separate internal identifier fields, original files, device/provider provenance, and arbitrary stored stats are excluded.',
