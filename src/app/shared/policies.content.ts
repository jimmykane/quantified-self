...
export const CONNECTED_SERVICES_POLICY_SECTION: ConnectedServicesPolicySection = {
    ...
    topics: [
        ...
        },
        {
            ...
            summary: 'Suunto activity, sleep, route import, FIT upload, and activity or route delivery workflows.',
            content: [
