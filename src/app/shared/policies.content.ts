...
export const CONNECTED_SERVICES_POLICY_SECTION: ConnectedServicesPolicySection = {
    ...
    topics: [
        ...
        },
        {
            ...
            summary: 'Wahoo OAuth, webhook, FIT activity and course/route delivery, and history-import workflows.',
            content: [
                ...
                '<strong>Shared with Wahoo:</strong> You can explicitly send a selected FIT activity file or FIT course/route file directly to Wahoo, or turn on/send a date range for Garmin, COROS, or Suunto activities already stored in Quantified Self. Direct Wahoo activity delivery does not create or retain a Quantified Self activity; direct course/route delivery does not create or retain a Quantified Self route.',
                ...
                '<strong>Outbound boundaries:</strong> Wahoo-to-Suunto is the only Wahoo-origin provider-to-provider activity route. Direct FIT course/route delivery is a separate Wahoo-only upload and is not a saved-route sync to another provider. Plans, sleep, and other non-activity data are not sent between Wahoo and another provider. Existing Wahoo connections may need to be reconnected to grant workout and route access for delivery to Wahoo.',
            ],
        },
        {
