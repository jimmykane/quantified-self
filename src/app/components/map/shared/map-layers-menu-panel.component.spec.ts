...
describe('MapLayersMenuPanelComponent', () => {
  let component: MapLayersMenuPanelComponent;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      declarations: [MapLayersMenuPanelComponent, MenuRadioListComponent],
      providers: [
    ...
    fixture = TestBed.createComponent(MapLayersMenuPanelComponent);
