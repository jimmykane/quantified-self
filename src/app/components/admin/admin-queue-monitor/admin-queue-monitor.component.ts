...
export class AdminQueueMonitorComponent implements OnInit, OnDestroy {
    ...
    pageSubtitle = 'Operational health for ingestion and reparse pipelines';
    ...
    private configureView(): void {
        ...
        if (rawView === 'workout' || rawView === 'reparse') {
        ...
        this.pageSubtitle = 'Operational health for ingestion and reparse pipelines';
    }
