    ...
    syncFlows: [
      {
        ...
        copy: 'Import activities from Garmin\'s latest rolling five-year history window. The picker starts with the latest 30 days selected; you can expand it to any allowed range before importing.',
      },
      {
        icon: 'monitor_heart',
  ...
  coros: {
    ...
    syncFlows: [
      ...
      },
      {
        ...
        copy: 'Start with the latest 30 days of COROS activity history selected, or expand the range up to the current three-month provider limit, then review the imported activities from the same dashboard as Garmin and Suunto.',
      },
      {
        icon: 'published_with_changes',
  ...
  wahoo: {
    ...
    syncFlows: [
      ...
      },
      {
        ...
        copy: 'Start with the latest 30 days selected, or choose a longer date range in Services to page through Wahoo history and queue workouts that include an importable FIT file.',
      },
      {
        icon: 'update',
