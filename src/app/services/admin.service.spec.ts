...
describe('AdminService', () => {
    ...
    it('should default missing event count fields from getUserCount', async () => {
        ...
        expect(stats.events).toEqual({ total: 0, standard: 0, benchmark: 0 });
        expect(stats.eventsBackfilled).toBe(false);
    });
