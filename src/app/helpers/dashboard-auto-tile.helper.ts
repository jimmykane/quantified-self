...
export const DASHBOARD_AUTO_TILE_KPI_ID_BY_CHART_TYPE: Record<DashboardKpiChartType, AppDashboardAutoTileId> = {
  ...
  [DASHBOARD_LOAD_STATUS_KPI_CHART_TYPE]: 'kpiLoadStatus',
  ...
  [DASHBOARD_FITNESS_TREND_KPI_CHART_TYPE]: 'kpiFitnessTrend',
  [DASHBOARD_FATIGUE_TREND_KPI_CHART_TYPE]: 'kpiFatigueTrend',
  [DASHBOARD_RECOVERY_DEBT_KPI_CHART_TYPE]: 'kpiRecoveryDebt',
  [DASHBOARD_FORM_PLUS_7D_KPI_CHART_TYPE]: 'kpiFormPlus7d',
  [DASHBOARD_TRAINING_BALANCE_KPI_CHART_TYPE]: 'kpiTrainingBalance',
