...
const DASHBOARD_CHART_INFO_COPY: Record<DashboardSpecialChartType, string> = {
  ...
  [DASHBOARD_POWER_CURVE_CHART_TYPE]: 'Power Curve compares your best power per duration inside this tile range with the newest matching activity that has power-curve data. Cycling and running Power Curve tiles use separate activity filters, so their envelopes are not mixed.',
