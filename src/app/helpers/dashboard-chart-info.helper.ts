...
const DASHBOARD_CHART_INFO_COPY: Record<DashboardSpecialChartType, string> = {
  ...
  [DASHBOARD_FORM_CHART_TYPE]: 'Form uses TSS-derived CTL (42-day EMA) and ATL (7-day EMA). Form (TSB) is prior-day CTL minus ATL: more negative means more fatigue, around zero is balanced, positive is fresher.',
  ...
  [DASHBOARD_FORM_NOW_KPI_CHART_TYPE]: 'Form Now is prior-day TSB (CTL minus ATL) from your latest derived state. Negative values indicate residual fatigue; positive values indicate fresher readiness.',
  [DASHBOARD_FORM_PLUS_7D_KPI_CHART_TYPE]: 'Form +7d projects prior-day TSB seven days ahead assuming zero new load. Use it to gauge expected freshness if training load is reduced.',
