...
const DASHBOARD_CHART_INFO_COPY: Record<DashboardSpecialChartType, string> = {
  ...
  [DASHBOARD_HRV_TREND_CHART_TYPE]: 'HRV uses the same source-separated chart as Health, including recorded Sleep HRV. For eligible nightly series, the shaded personal range and reading colors use the same 60-day baseline as Health. Missing readings remain gaps; naps are excluded. HRV and Sleep share the dashboard date range and navigation.',
