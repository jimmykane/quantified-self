...
const DASHBOARD_CHART_INFO_COPY: Record<DashboardSpecialChartType, string> = {
  ...
  [DASHBOARD_HRV_TREND_CHART_TYPE]: 'HRV shows recorded overnight average heart rate variability from synced sleep sessions. Each source has a separate trend and dashed range average. Missing readings remain gaps; naps are excluded. HRV and Sleep share the dashboard sleep date range and navigation.',
