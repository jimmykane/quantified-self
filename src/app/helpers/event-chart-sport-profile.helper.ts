...
const ACTIVITY_GROUP_PROFILE: Record<MappedActivityTypeGroup, EventChartSportProfileID> = {
  ...
  [ActivityTypeGroups.SkatingGroup]: PROFILE_IDS.IceSkating,
  [ActivityTypeGroups.AerialSportsGroup]: PROFILE_IDS.Paragliding,
  [ActivityTypeGroups.MotorizedGroup]: PROFILE_IDS.Motor,
  [ActivityTypeGroups.AdaptiveMobilityGroup]: PROFILE_IDS.Cycling,
