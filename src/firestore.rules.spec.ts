...
describe('Firestore Security Rules', () => {
    ...
    describe('Service token pending disconnect protection', () => {
        ...
        it('denies Garmin credential reads and mutations even to the owner', async () => {
            ...
            await assertFails(db.doc(`garminAPITokens/${userId}/subscriptions/forged`).get());
    ...
    describe('Suunto server-owned OAuth state and token credentials', () => {
        ...
        it('denies Suunto credential and provider-identity reads and mutations even to the owner', async () => {
            await testEnv.withSecurityRulesDisabled(async (context) => {
    ...
    describe('COROS server-owned token credentials', () => {
        ...
        it('denies COROS credential and identity reads and mutations even to the owner', async () => {
            await testEnv.withSecurityRulesDisabled(async (context) => {
