...
export const AI_INSIGHTS_PROMPT_CATALOG = [
  ...
  {
    id: 'advisory-estimate-max-heart-rate-cycling-confidence',
  ...
  {
    id: 'advisory-current-achievable-max-heart-rate-running-this-year',
    prompt: 'What should my current achievable max heart rate be this year for running?',
    category: 'Advanced Examples',
    featured: false,
    surfaces: ['picker'],
    metricKey: 'heart_rate',
