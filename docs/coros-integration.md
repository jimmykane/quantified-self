...
8. Monitor provider permission/auth/binding errors, upload pending age, unknown/mismatched statuses, FIT-detail recovery, queue retries/DLQ, route rejection and duplicate codes, echo-suppression counts, fingerprint-write failures, disconnect-pending age, and account-cleanup failures.
