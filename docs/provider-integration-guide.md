...
Suunto is the first adapter to support the editor's exact running/cycling and Swimming profiles. Its documented Guide `activities`
array receives provider IDs only at serialization time: Running `1`, Trail Running `22`, Treadmill `53`, Cycling `2`,
Mountain Biking `10`, Indoor Cycling `52`, E-Biking `105` and E-MTB `106`, Hand Cycle `109`, and Swimming `21`. Generic Cycling does
...
new COROS delivery setup. Wahoo remains limited to its proved Running/Cycling baseline and does not accept Swimming.
