...
| COROS    | Activity and daily sleep-summary import, activity upload, and activity sync to Suunto/Wahoo | Sleep polling runs every 24 hours over a rolling 7-day window. The documented daily endpoint supplies timing, average sleep HR, resting HR, and overnight HRV, but not sleep stages. |
