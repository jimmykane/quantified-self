...
export const SECRET_PARAMS = {
  ...
  SUUNTOAPP_GUIDES_SUBSCRIPTION_KEY: defineSecret('SUUNTOAPP_GUIDES_SUBSCRIPTION_KEY'),
...
export const FUNCTION_SECRET_BINDINGS = {
  ...
  processTrainingDeliveryTask: [...GARMIN, ...SUUNTO, SECRET_PARAMS.SUUNTOAPP_GUIDES_SUBSCRIPTION_KEY],
