...
export const SECRET_PARAMS = {
  ...
  MARKETING_UNSUBSCRIBE_SIGNING_KEY: defineSecret('MARKETING_UNSUBSCRIBE_SIGNING_KEY'),
  ...
  SUUNTOAPP_GUIDE_OWNER: defineSecret('SUUNTOAPP_GUIDE_OWNER'),
...
export const FUNCTION_SECRET_BINDINGS = {
  ...
  assistantChat: [SECRET_PARAMS.GEMINI_API_KEY, SECRET_PARAMS.SUUNTOAPP_GUIDE_OWNER],
  applyAssistantTrainingProposal: [SECRET_PARAMS.SUUNTOAPP_GUIDE_OWNER],
  ...
  changeMarketingCampaignStatus: [SECRET_PARAMS.MARKETING_UNSUBSCRIBE_SIGNING_KEY],
  dispatchMarketingCampaigns: [SECRET_PARAMS.MARKETING_UNSUBSCRIBE_SIGNING_KEY],
  marketingUnsubscribe: [SECRET_PARAMS.MARKETING_UNSUBSCRIBE_SIGNING_KEY],
  ...
  mcpApi: [SECRET_PARAMS.MAPBOX_ACCESS_TOKEN, SECRET_PARAMS.SUUNTOAPP_GUIDE_OWNER],
  mutateTrainingProviderDelivery: [SECRET_PARAMS.SUUNTOAPP_GUIDE_OWNER],
  ...
  processTrainingDeliveryTask: [...COROS, ...GARMIN, ...SUUNTO_API, ...WAHOO, SECRET_PARAMS.SUUNTOAPP_GUIDE_OWNER],
  ...
  previewTrainingProviderDelivery: [SECRET_PARAMS.SUUNTOAPP_GUIDE_OWNER],
