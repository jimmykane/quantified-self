...
export const SECRET_PARAMS = {
  ...
  WAHOOAPI_ACTIVITY_UPLOAD_RESUME_SIGNING_KEY: defineSecret('WAHOOAPI_ACTIVITY_UPLOAD_RESUME_SIGNING_KEY'),
...
const WAHOO_ACTIVITY_UPLOADS: SecretParam[] = [
  ...WAHOO,
  SECRET_PARAMS.WAHOOAPI_ACTIVITY_UPLOAD_RESUME_SIGNING_KEY,
];
...
export const FUNCTION_SECRET_BINDINGS = {
  ...
  receiveSuuntoAppSleepData: [SECRET_PARAMS.SUUNTOAPP_NOTIFICATION_SECRET],
