...
async function createGarminCourse(
  ...
  try {
    ...
    throw toGarminRouteProviderError(error, 'route_create', tokenSnapshotRef.providerUserId);
  }
}
...
async function updateGarminCourse(
  ...
  try {
    ...
    throw toGarminRouteProviderError(error, 'route_update', tokenSnapshotRef.providerUserId, courseId);
  }
}
