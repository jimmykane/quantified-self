...
const EXPECTED_BINDINGS: Record<string, string[]> = {
  ...
  assistantChat: ['GEMINI_API_KEY', 'SUUNTOAPP_GUIDE_OWNER'],
  applyAssistantTrainingProposal: ['SUUNTOAPP_GUIDE_OWNER'],
  ...
  dispatchMarketingCampaigns: ['MARKETING_UNSUBSCRIBE_SIGNING_KEY'],
  ...
  marketingUnsubscribe: ['MARKETING_UNSUBSCRIBE_SIGNING_KEY'],
  mcpApi: ['MAPBOX_ACCESS_TOKEN', 'SUUNTOAPP_GUIDE_OWNER'],
  mutateTrainingProviderDelivery: ['SUUNTOAPP_GUIDE_OWNER'],
  ...
  processTrainingDeliveryTask: [...COROS, ...GARMIN, ...SUUNTO_API, ...WAHOO, 'SUUNTOAPP_GUIDE_OWNER'],
  ...
  previewTrainingProviderDelivery: ['SUUNTOAPP_GUIDE_OWNER'],
  ...
  sendMarketingTest: ['MARKETING_UNSUBSCRIBE_SIGNING_KEY'],
